import 'package:star_example/pages/now_playing.dart';
import 'package:star_example/widgets/mp_inherited.dart';
import 'package:star_example/widgets/mp_lisview.dart';
...
class RootPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Star Music Player Flutter"),
        actions: <Widget>[
          new Container(
